            ...
            <div class="flex justify-center bg-gray-100 py-10 p-14">
                ...
                <div class="container mx-auto pr-4">
                    <div
                        ...
                        <p class="py-4 text-3xl ml-5">{{ $doctor->doctor['patients'] }}</p>
                    </div>
                </div>
                ...
                <div class="container mx-auto pr-4">
                    <div
                        ...
                        <p class="py-4 text-3xl ml-5">
                            @php
                                $rating = $reviews->isNotEmpty() ? $reviews->sum('ratings') / $reviews->count() : 0;
                            @endphp
                ...
                <div class="container mx-auto pr-4">
                    <div
                        ...
                        <p class="py-4 text-3xl ml-5">{{ $reviews->count() }}</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-7 mt-4">
                        <div class="card">
                            ...
                            <div class="card-body pt-4 pb-3">
                                                ...
                                                <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <span class="flex justify-between">
                                                            <span class="h2 text-xs">{{ $review->reviews ?? '' }}</span>
                                                            <span
                                                                class="mb-2 text-xs">{{ $review->created_at ?? '' }}</span>
                                                        </span>
                                                    </div>
                                                </li>
                                            @endif
                                ...
                                @else
                                    <div class="border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-raduis-lg">
